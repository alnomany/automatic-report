...
<head>
    ...
    <style type="text/css">
        ...
        @font-face {
            src: url('{{env('FONT_STYLE_PATH')}}din-next-lt-w23-bold.ttf') format('truetype');
            font-family: DINNextLTArabic-Regular;
        }

        @font-face {
            src: url('{{env('FONT_STYLE_PATH')}}din-next-lt-arabic-regular.ttf') format('truetype');
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="vertical-align: top;">
                        <div class="article-item-desc"><p>نص المقال نص المقال نص المقال نص المقال نص المقال نص نص المقال نص المقال نص المقال نص المقال نص المقال نص نص المقال نص المقال نص المقال نص المقال نص المقال نص  نص المقال نص المقال نص المقال نص المقال نص المقال نص نص المقال نص المقال نص المقال نص المقال نص المقال نص نص المقال نص المقال نص المقال نص المقال نص المقال نصنص المقال نص المقال نص المقال نص المقال نص المقال نص المقال نص المقال نص المقال نص المقال نص المقالنص المقال نص المقالنص المقال نص المقال</p><br></div>
                        <table style="width: 100%;">
                            <tr>
                                <td>
                                    <div class="Date">
