...
<head>
    ...
    <style>
        ...
        @font-face {
            src: url('{{asset('fonts/DINNextLTArabic-Regular-2.ttf')}}') format('truetype');
            font-family: DINNextLTArabic-RegularX;
        }

        @font-face {
            src: url('{{asset('fonts/din-next-lt-w23-bold.ttf')}}') format('truetype');
            font-family: DINNextLTArabic-Regular;
        }

        @font-face {
            src: url('{{asset('fonts/din-next-lt-arabic-regular.ttf')}}') format('truetype');
        ...
        body, html {
            ...
            background-image: url({{ asset('/uploads/reportsd/Picture2.png') }}) !important;
...
<table cellpadding="0" style="width:100%; text-align: center; padding-bottom: 0; margin-bottom: 0;">
    <tr style="vertical-align: bottom">
        <td><img width="140" height="140" style="max-width: none"
                 src="{{ asset('/uploads/reportsd/report_daily.png')  }}" alt="image"></td>
        <td><img width="35" height="35" style="max-width: none" src="{{ asset('/uploads/reportsd/line.png')  }}"
                 alt="image"></td>
        <td><img width="140" height="140" style="max-width: none"
                 src="{{ asset('/uploads/reportsd/logo2.png')  }}"
                 alt="image"></td>
    </tr>
</table>
<!-- //Header End -->
<table style="width: 100%;padding-top:15px;">
    <tr>
        <td class="article-item-title"><p class="p">يوم الاثنين 1440 مايو 44</p></td>
    </tr>
</table>
...
@for($i=0;$i<$posts;$i++)
    ...
    <div class="wrapper">
        ...
        <div class="AllIncidents" style="">
            ...
            <table style="width: 100%;">
                <tr>
                    <td style="width: 15%;"><img class="IncidentImg" src="{{ asset('/images/dincidents.png')  }}"
                                                 alt="image">
                        <div class="Date ds"><span class="Dtitle"><p class="year source"> المصدر</p><img
                                    class="IncidentIm postImg" width="80" height="55"
                                    src="{{ asset('/uploads/reportsd/source_logo.png')  }}" alt="image"></span>
                        </div>
                    </td>
        ...
        <div class="AllIncidents" style="">
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <div class="article-item-desc"><p> الخبر الاول الخبر الاول الخبر الاول الخبر الاول الخبر الاول
                                الخبر الاول الخبر الاول الخبر الاول الخبر الاول الخبر الاول الخبر الاول الخبر الاول
                                الخبر الاول الخبر الاول الخبر الاول الخبر الاول الخبر الاول الخبر الاول الخبر الاول
                                الخبر الاول الخبر الاول</p><br></div>
                        <table style="width: 100%;">
                            <tr>
                                <td>
                                    <div class="Date">
