    ...
    <header  style=" !important;padding: 10px;">
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6 col-6">
              <center>  <img class="IncidentImg top" width="150" height="150"  style=" padding-top: 5% !important;" src="{{ URL::to('/uploads/reportsd/report_daily.png')  }}"
                alt="image"></center>
            </div>
            <div class="col-sm-2 col-md-2 col-lg-2 col-2">
                <img class="IncidentImg top" width="40" height="40" style=" padding-top: 5% !important;" src="{{ URL::to('/uploads/reportsd/line.png')  }}"
                alt="image">
            </div>
            <div class="col-sm-4 col-md-4 col-lg-4 col-4">
              <center>  <img class="IncidentImg top" width="150" height="150" style=" padding-top: 5% !important;" src="{{ URL::to('/uploads/reportsd/logo2.png')  }}"
                alt="image"></center>
            </div>
        </div>
